...
public class MainViewAdapter extends RecyclerView.Adapter<MainViewAdapter.Holder> {
    ...
    private List<MarketRecycleItem> list = new ArrayList<>();

    public MainViewAdapter(Context context, List<MarketRecycleItem> list) {
    ...
    public void onBindViewHolder(Holder holder, int position) {
        ...
        holder.imageView.setImageResource(list.get(itemposition).getIconDrawable());
        holder.TitleText.setText(list.get(itemposition).getTitleStr());
        holder.descText.setText(list.get(itemposition).getDescStr());
        holder.descText2.setText(list.get(itemposition).getDescStr2());
