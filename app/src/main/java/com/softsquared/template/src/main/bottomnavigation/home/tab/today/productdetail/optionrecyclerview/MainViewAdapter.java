...
public class MainViewAdapter extends RecyclerView.Adapter<MainViewAdapter.Holder> {
    ...
    private List<OptionResult> list = new ArrayList<>();

    private LinearLayout layout_album_panel;

    public MainViewAdapter(Context context, List<OptionResult> list) {
...
*/
    ...
    public class Holder extends RecyclerView.ViewHolder{
        ...
        public Holder(View view){
         ...
         //   imageView_review =  view.findViewById(R.id.image_normal1);
