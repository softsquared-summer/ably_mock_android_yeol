...
public class tabnewRecyclerItem {
    ...
    {
        return "ClassPojo [productIdx = "+productIdx+", displayedPrice = "+displayedPrice+", marketName = "+marketName+", marketIdx = "+marketIdx+", isMyHeart = "+isMyHeart+", isHotDeal = "+isHotDeal+", isNew = "+isNew+", productName = "+productName+", thumbnailUrl = "+thumbnailUrl+", discountRatio = "+discountRatio+"]";
    }
